...
export const filledButtonStyles: { [key in color]: string } = {
    ...
    labrodite: "bg-labrodite-500 active:bg-labrodite-600",
...
export const ghostButtonStyles: { [key in color]: string } = {
    ...
    labrodite: "border-labrodite-500 text-labrodite-500 hover:border-labrodite-400/60 hover:text-labrodite-400/60 active:bg-labrodite-400/5",
...
export const textButtonStyles: { [key in color]: string } = {
    ...
    labrodite: "text-labrodite-400 hover:bg-labrodite-400/10 hover:text-labrodite-400 active:bg-labrodite-400/20",
