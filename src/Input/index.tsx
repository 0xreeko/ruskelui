...
export const RuiInput = ({ id, disabled, label, placeholder, variant, floatingLabel, name = "username", color = "kunzite", fullWidth = false, leftIcon, rightIcon}: RuiInputProps) => {
