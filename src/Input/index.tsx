        ...
        case "text":
            return (
                ...
                <div className={`relative group ${fullWidth ? "w-full" : "w-full max-w-xs"}`} >
                    ...
                    <span className={`absolute inset-y-0 ${iconPosition === 'left' ? 'left-0' : 'right-0'} grid w-10 duration-200 pointer-events-none place-content-center peer-focus:text-jade-500 peer-hover:text-jade-500 text-jade-500 peer-placeholder-shown:text-obsidian-500`}>
                        {icon && (
                            icon
                        )}
                    </span>
