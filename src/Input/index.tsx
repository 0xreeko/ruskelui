        ...
        case "text":
            return (
                ...
                <div className={`relative group ${fullWidth ? "w-full" : "w-full max-w-xs"}`} >
                    ...
                    <span className={`absolute inset-y-0 ${iconPosition === 'left' ? 'left-0' : 'right-0'} grid w-10 duration-3 00 pointer-events-none place-content-center ${inputColor[color][1]} peer-placeholder-shown:text-obsidian-300 dark:peer-placeholder-shown:text-obsidian-800`}>
                        {icon && (
                            icon
                        )}
                    </span>
