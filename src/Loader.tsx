...
export const RuiLoader:FC<Props> = ({color = "peridot", name}) => {
    return (
        <div role={'status'} title={name} id={name}>
            <svg className={`inline w-8 h-8 mr-2 text-gray-700 animate-spin dark:text-gray-600' ${color.includes('rgb') ? `fill-[color:${color}]` : colorVar[color]}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
