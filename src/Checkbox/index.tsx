...
export const RuiCheckbox = ({color = 'ruby', variant ="white", id, defaultChecked, disabled, value, checked, onClick, onChange }: RuiCheckboxProps) => {
  return (
    <label className={`${ disabled !== true ? `${styles[color]} cursor-pointer` : "bg-sylver-800 pointer-events-none" } select-none rounded-md w-5 h-5 min-h-fit flex items-center relative`}>
