...
const Template: Story<RuiBreadcrumbParentProps> = args => <RuiBreadcrumbs {...args}>
    <RuiBreadcrumbs.Item icon={icono} color={'tingual'} divider={'arrow'} variant="previous" route='/'>Home</RuiBreadcrumbs.Item>
    <RuiBreadcrumbs.Item icon={icono} color={'tingual'} divider={'arrow'} variant="previous" route='/sapo'>Sapo</RuiBreadcrumbs.Item>
